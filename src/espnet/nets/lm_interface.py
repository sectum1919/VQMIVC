...
from src.espnet.nets.scorer_interface import ScorerInterface
from src.espnet.utils.dynamic_import import dynamic_import
from src.espnet.utils.fill_missing_args import fill_missing_args
...
class LMInterface(ScorerInterface):
    ...
    def build(cls, n_vocab: int, **kwargs):
        ...
        from src.espnet.bin.lm_train import get_parser
