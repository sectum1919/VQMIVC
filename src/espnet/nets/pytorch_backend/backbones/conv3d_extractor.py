...
from src.espnet.nets.pytorch_backend.backbones.modules.resnet import BasicBlock, ResNet
from src.espnet.nets.pytorch_backend.transformer.convolution import Swish
